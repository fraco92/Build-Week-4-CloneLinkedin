...
export const Navbar = () => {
  ...
  return (
    <>
      <div data-theme="light" className="flex items-center bg-base-100 gap-2">
        <div className="flex items-center m-auto py-3">
          ...
          <div className="ms-10 hidden lg:flex icons text-center items-center gap-5">
